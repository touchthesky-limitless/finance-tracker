...
export default async function CalculatorPage() {
    ...
    return (
        <main className="min-h-screen bg-gray-50 dark:bg-black py-16 px-6 lg:px-12 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-16 space-y-4">
                    ...
                    <p className="max-w-2xl text-gray-600 dark:text-gray-500 text-lg font-medium leading-relaxed">
                        Optimize your debt structure with real-time market insights. 
                        Today’s benchmark: <span className="text-gray-900 dark:text-white font-black">{currentRate.toFixed(2)}%</span>
                    </p>
                </div>
                ...
                <div className="relative group">
                    ...
                    <div className="relative bg-white dark:bg-[#0d0d0d] border border-black/5 dark:border-white/5 rounded-[38px] p-2 md:p-8 shadow-2xl">
                        <RefinanceCalculator nationalRate={currentRate} />
                    </div>
                </div>

                {/* Footnote / Disclaimer */}
                <div className="mt-12 flex items-start gap-4 p-6 rounded-3xl bg-black/5 dark:bg-white/2 border border-black/5 dark:border-white/5">
                    <div className="p-2 rounded-xl bg-black/5 dark:bg-white/5 text-gray-600 dark:text-gray-400">
                        <Calculator size={20} />
                    </div>
