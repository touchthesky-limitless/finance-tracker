	...
	return (
		<SettingsContentCard
			...
			actions={
				<button
					type="button"
					className="inline-flex h-10 items-center gap-2 rounded-xl border border-black/10 bg-white px-4 text-sm font-semibold shadow-sm hover:bg-black/[0.03] dark:border-white/10 dark:bg-[#222220] dark:hover:bg-white/5"
				>
					Options
					<ChevronDown size={15} />
				</button>
				...
				<div className="mt-7 flex flex-wrap items-center justify-between gap-4">
					...
					<div className="flex flex-1 items-center justify-end gap-3 sm:flex-none">
						...
						<button
							...
							className="inline-flex h-11 shrink-0 items-center gap-2 rounded-xl bg-[#ff5a35] px-4 text-sm font-semibold text-white hover:bg-[#e94c28]"
						>
							<Plus size={16} />
							Create rule
						</button>
...
function RuleCard({
	...
	return (
		...
		>
			...
			<div className="min-w-0 border-t border-gray-200 px-4 py-4 dark:border-white/10 sm:px-5 lg:border-l-0 lg:border-t-0">
