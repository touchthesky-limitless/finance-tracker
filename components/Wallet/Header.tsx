...
export function WalletHeader({
	...
	return (
		<div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-gray-200 dark:border-white/5 pb-8">
			<div className="space-y-2">
				<h1 className="text-3xl font-black tracking-tighter uppercase italic text-gray-900 dark:text-white">
					Spend Optimizer
				</h1>
			</div>
			...
			<div className="flex items-center gap-3">
				<button
					...
					className="flex items-center gap-3 bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 hover:border-gray-400 dark:hover:border-gray-500/50 px-4 py-2.5 rounded-xl shadow-xl text-gray-500 dark:text-gray-400 group transition-all"
				>
					<Search size={18} />
				...
				<button
					...
					className="flex items-center gap-3 bg-white dark:bg-[#111] border border-gray-200 dark:border-white/20 hover:border-blue-400 dark:hover:border-blue-500/50 px-4 py-2.5 rounded-xl shadow-xl transition-all text-gray-900 dark:text-white"
				>
				...
				<Popover.Root>
					<Popover.Trigger asChild>
						<button className="flex items-center gap-2 bg-white dark:bg-[#111] border border-gray-200 dark:border-white/20 hover:border-emerald-400 dark:hover:border-emerald-500/50 px-4 py-2.5 rounded-xl shadow-xl text-gray-900 dark:text-white text-sm font-bold transition-all">
