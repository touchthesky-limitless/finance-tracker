...
export function TopToolbar({
	...
	return (
		<div
			...
			"
		>
			{/* LEFT GROUP: Title + Tabs – now always rendered, hidden on mobile via CSS */}
			<div className="hidden md:flex items-center gap-3 md:gap-8 w-full md:w-auto pb-2 md:pb-0">
