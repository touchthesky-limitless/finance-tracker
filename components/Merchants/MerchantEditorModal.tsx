/**
 * Modal for editing a merchant's name, logo, and recurring status.
 * Also provides a button to open the merge dialog.
 */
"use client";
...
export function MerchantEditorModal({
	...
	const handleSave = async () => {
		...
		setErrorMessage(null);
		try {
			await onSave({ name: cleanName, logoUrl, isRecurring });
		} catch (error) {
			setErrorMessage(
