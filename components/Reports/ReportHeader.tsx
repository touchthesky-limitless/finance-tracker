						...
						await onEditSavedReport(
							...
							name,
							{
								tab:
									editingReport.tab,
								dateRange:
									editingReport.dateRange,
								filters:
									editingReport.filters,
								view:
									editingReport.view,
								grouping:
									editingReport.grouping,
								interval:
									editingReport.interval,
								breakdownChart:
									editingReport.breakdownChart,
								trendChart:
									editingReport.trendChart,
								includeChartSettings,
							},
						);
					} else {
