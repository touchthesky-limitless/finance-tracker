			...
			<div className="bg-white dark:bg-[#121212] border border-black/10 dark:border-white/10 p-8 rounded-4xl shadow-2xl">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					...
					<InputGroup label="Credit Tier">
						<select
							aria-label="Select your credit score range"
							value={creditScore}
...
function InputGroup({
	...
	//gemini.google.com/app/2c05bbca7b3b0ea2
	https: return (
...
function Stat({
	...
	return (
		<div className="text-left">
			...
			<p
				className={`text-4xl font-black tracking-tighter ${highlight ? "text-orange-600" : "text-gray-900 dark:text-white"}`}
			>
				{value}
				{sub && (
					<span className="text-xs font-bold text-gray-600 ml-1">{sub}</span>
				)}
			</p>
		</div>
	);
