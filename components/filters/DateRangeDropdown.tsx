		...
		<div className="relative">
			...
			{isOpen && (
				<>
					...
					/>
					<div className="absolute right-0 mt-2 w-[320px] sm:w-80 bg-white dark:bg-[#121212] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl z-50 flex flex-col sm:flex-row overflow-hidden animate-in fade-in slide-in-from-top-2">
						{/* --- LEFT: PRESETS --- */}
