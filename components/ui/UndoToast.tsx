...
export function UndoToast({
	...
	return createPortal(
		...
		>
			<div className="relative overflow-hidden bg-white dark:bg-[#121212] text-gray-900 dark:text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-6 border border-gray-200 dark:border-white/10">
				{/* Progress Bar: 
                ...
                */}
				{show && (
					<div
						key={message}
						className="absolute bottom-0 left-0 h-1 bg-orange-500 animate-shrink"
						style={{
				...
				<button
					type="button"
					onClick={onUndo}
					className="flex items-center gap-2 text-sm font-black uppercase tracking-widest text-orange-600 dark:text-orange-500 hover:text-orange-700 dark:hover:text-orange-400 transition-colors group"
				>
					<RotateCcw
						size={14}
